        ...
        <div class="container-fluid max-w-4xl px-3">
            ...
            <div class="card border-0 bg-white rounded-3 shadow-sm mb-4">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label font-weight-semibold text-dark small mb-1">Luas Area (m²)</label>
                    ...
                    <!-- Deskripsi -->
                    <div class="mb-0">
                        <label class="form-label font-weight-semibold text-dark small mb-1">Deskripsi Tambahan</label>
                ...
                <div class="card-body p-4">
                    <div class="alert alert-info border-0 shadow-sm d-flex align-items-center mb-3 rounded-3"
                        ...
                        <span class="small">Anda sedang memproses pertimbangan untuk <strong>Level
                                {{ $approvalLevel->level ?? ($warehouseRequest->current_approval_level ?? 1) }}</strong>.</span>
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <form action="{{ route('approvals.approve', $warehouseRequest) }}" method="POST"
                            class="d-inline">
                            @csrf
                            <button type="submit" class="btn btn-success btn-sm font-weight-bold px-3 py-2 rounded-2"
                                onclick="return confirm('Apakah Anda yakin ingin menyetujui (Approve) pengajuan ini?')">
                                <i class="bi bi-check-lg me-1"></i> Approve
                            </button>
                        </form>

                        <button type="button" class="btn btn-danger btn-sm font-weight-bold px-3 py-2 rounded-2"
